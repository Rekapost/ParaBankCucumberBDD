...
![alt text](parabankImages/image-3.png)
![alt text](parabankImages/image-4.png)

Allure Report:
![alt text](parabankImages/image-5.png)
...
![alt text](parabankImages/image-7.png)

Docker-Selenium Grid:
docker-compose up -d --scale chrome=3 --scale firefox=3 && mvn clean test
![alt text](parabankImages/image-20.png)
...
![alt text](parabankImages/image-6.png)

Docker image:
docker build -t parabank-bdd-cucumber-framework . 
![alt text](parabankImages/image-8.png)
...
![alt text](parabankImages/image-9.png)

Github Actions:
![alt text](parabankImages/image-10.png)

Performance Testing:
Stress Testing:
![alt text](parabankImages/image-17.png)
![alt text](parabankImages/image-18.png)

Load Test:
![alt text](parabankImages/image-19.png)
...
C:\Users\nreka\vscodedevops\parabank>mvn clean verify sonar:sonar -Dsonar.projectKey=ParaBankCucumberBDD -Dsonar.organization=rekasonar -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=45775b8469d4619ddd24d7e5faf3aa4e0
  ![alt text](parabankImages/image-11.png)
  ![alt text](parabankImages/image-15.png)
  ![alt text](parabankImages/image-16.png)

Jenkins File CI-CD:
![alt text](parabankImages/image-12.png)  
